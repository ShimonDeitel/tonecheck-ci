            ...
            ScrollView {
                VStack(spacing: 22) {
                    VStack(spacing: 8) {
                        ...
                        Text("ToneCheck Pro").font(.largeTitle.weight(.heavy))
                    ...
                    VStack(spacing: 12) {
                        Button { Task { await buy() } } label: {
                            HStack {
                                ...
                                Text(working ? "Unlocking…" : "Unlock ToneCheck Pro · \(store.displayPrice)")
                                    .font(.headline)
                            }
                        ...
                        Text("ToneCheck never tracks you. Your breathing stays on your device.")
